@php
    $navLinks = [
        'Booking Management' => route('admin.orders'), // Updated route name
        'Create Booking' => '#',
    ];
@endphp

<x-layout.admin-app-layout title="Create Booking" :breadcrumbs="$navLinks">
    ...
    <div class="p-6" x-data="bookingForm()">
        ...
        <div x-show="showSuccess" x-cloak x-transition:enter="transition ease-out duration-300"
            ...
            <div class="ms-3 text-sm font-bold">Booking created successfully!</div>
        ...
        <div class="flex items-center justify-between mb-8">
            <div class="space-y-1">
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Create Manual Booking</h1>
                <p class="text-base font-normal text-gray-500">Register a new event booking for a client.</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <form @submit.prevent="submitForm" class="bg-white border border-gray-200 rounded-xl shadow-sm">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" x-model="formData.fullname"
                                    ...
                                    :class="errors.fullname ? 'border-red-500 bg-red-50' : 'border-gray-300'"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="tel" x-model="formData.phone"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 block w-full p-3 transition-all outline-none"
                                    :class="errors.phone ? 'border-red-500 bg-red-50' : 'border-gray-300'"
                            ...
                            <div class="col-span-6">
                                <label class="block mb-2 text-sm font-bold text-gray-700">Initial Status</label>
                    ...
                    <div
                        ...
                        <a href="{{ route('admin.orders') }}"
                            class="text-gray-600 hover:text-orange-600 text-sm font-bold transition-colors">Discard</a>
                        <button type="submit" :disabled="loading"
                            ...
                            <span x-text="loading ? 'Saving...' : 'Create Booking'"></span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="xl:col-span-1">
                <div class="p-6 bg-slate-900 text-white rounded-xl shadow-sm space-y-6">
                    <h3 class="text-lg font-bold text-orange-500">Booking Summary</h3>
                    ...
                    <div class="bg-slate-800 p-4 rounded-lg text-xs text-slate-400 leading-relaxed">
                        <p><strong>Note:</strong> Guest count and total price are stored in the database. Ensure the
                            package is selected to calculate the amount accurately.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        function bookingForm() {
            return {
                ...
                async submitForm() {
                    ...
                    // Prepare data with the calculated total_price
                    const payload = {
                        ...this.formData,
                    ...
                    try {
                        // Ensure this route exists in your routes/web.php or routes/api.php
                        await axios.post("{{ route('admin.orders.store') }}", payload);
